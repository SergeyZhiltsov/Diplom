...
public class AcurianHealthResearchStudyLine extends MainPageBlinx {
    ...
    public final String titleExpected = "Thank you for calling Acurian Health's research study line. My name is Ivan Lipskyi and I'll be able to help you today. Are you calling about a research study?\n" +
            "\n" +
            "Agent notes:\n" +
