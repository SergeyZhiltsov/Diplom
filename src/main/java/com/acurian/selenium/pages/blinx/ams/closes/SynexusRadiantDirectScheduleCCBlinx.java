...
public class SynexusRadiantDirectScheduleCCBlinx extends MainPageBlinx {
...
//    WebElement studyName;
    ...
    @Step
    public SynexusRadiantDirectScheduleCCBlinx waitForPageLoad() {
        waitForPageLoadMain(titleText, titleExpected);
        return this;
    }

    @Step
    public SynexusRadiantDirectScheduleCCBlinx waitForPageLoadSyn() {
        waitForPageLoadMain(titleText, titleSynExpected);
        return this;
    }

    @Step
    public SynexusRadiantDirectScheduleCCBlinx clickOnAnswer(String answerText) {
        clickOnRadioButton(radioButtonsList, answerText);
        return this;
    }

    @Step
    public SynexusRadiantDirectScheduleCCBlinx assertVariables(String firstName, String secondName, String dateOfBirth, String country,
    ...
    @Step
    public SynexusRadiantDirectScheduleCCBlinx assertVariablesNew(String firstName, String secondName, String dateOfBirth, String country,
                                                             String cityAndState, String zipCode, String email, String phoneNumber,
                                                             String siteNumber, String siteName, String studyName) {
        SoftAssert softAssert = new SoftAssert();
