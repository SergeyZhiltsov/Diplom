...
public class HaveYouEverHadBotoxbotulinumtoxin_OLS extends MainPageOLS{
    ...
    public HaveYouEverHadBotoxbotulinumtoxin_OLS() {
        PageFactory.initElements(getDriver(), this);
    }

    @Step
    public HaveYouEverHadBotoxbotulinumtoxin_OLS waitForPageLoad() {
    ...
    @Step
    public HaveYouEverHadBotoxbotulinumtoxin_OLS clickOnAnswers(String ...answerText) {
