...
public class SubquestionHospitalizedOvernightPageOLS extends MainPageOLS{
    ...
    public SubquestionHospitalizedOvernightPageOLS() {
    ...
    @Step
    public SubquestionHospitalizedOvernightPageOLS clickOnAnswerForSubQuestion(int questionNumber, String answerText) {
    ...
    @Step
    public SubquestionHospitalizedOvernightPageOLS clickOnAnswerForSubQuestion(String questionText, String answerText) {
