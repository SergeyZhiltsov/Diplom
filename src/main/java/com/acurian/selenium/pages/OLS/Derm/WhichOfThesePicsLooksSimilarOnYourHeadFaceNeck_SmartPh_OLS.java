...
public class WhichOfThesePicsLooksSimilarOnYourHeadFaceNeck_SmartPh_OLS extends MainPageOLS {
    ...
    public WhichOfThesePicsLooksSimilarOnYourHeadFaceNeck_SmartPh_OLS() {
    ...
    @Step
    public WhichOfThesePicsLooksSimilarOnYourHeadFaceNeck_SmartPh_OLS clickOnAnswer(String answerText) {
