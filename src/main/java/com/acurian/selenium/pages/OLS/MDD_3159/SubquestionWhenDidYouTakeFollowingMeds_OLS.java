...
public class SubquestionWhenDidYouTakeFollowingMeds_OLS extends MainPageOLS{
...
//    List<WebElement> checkBoxList;
    ...
    public SubquestionWhenDidYouTakeFollowingMeds_OLS() {
    ...
    @Step
    public SubquestionWhenDidYouTakeFollowingMeds_OLS clickOnAnswerForSubQuestion(int questionNumber, String answerText) {
    ...
    @Step
    public SubquestionWhenDidYouTakeFollowingMeds_OLS clickOnAnswerForSubQuestion(String questionText, String answerText) {
