...
public class WhatTypeOfDoctorDiagnosedCH_CC extends MainPageCC{
    ...
    public WhatTypeOfDoctorDiagnosedCH_CC() {
    ...
    @Step
    public WhatTypeOfDoctorDiagnosedCH_CC clickOnAnswers(String ...answerText) {
