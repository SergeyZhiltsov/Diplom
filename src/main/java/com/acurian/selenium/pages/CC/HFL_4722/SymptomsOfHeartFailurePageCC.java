...
public class SymptomsOfHeartFailurePageCC extends MainPageCC {
    ...
    public SymptomsOfHeartFailurePageCC() {
        PageFactory.initElements(getDriver(), this);
    }

    @Step
    public SymptomsOfHeartFailurePageCC waitForPageLoad() {
        waitForPageLoadMain(titleText, titleExpected);
        return this;
    }

    @Step
    public SymptomsOfHeartFailurePageCC clickOnAnswer(String answerText) {
