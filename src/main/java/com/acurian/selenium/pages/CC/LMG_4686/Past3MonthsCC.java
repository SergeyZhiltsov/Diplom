...
public class Past3MonthsCC extends MainPageCC{
    ...
    public Past3MonthsCC() {
        PageFactory.initElements(getDriver(), this);
    }

    @Step
    public Past3MonthsCC waitForPageLoad() {
        waitForPageLoadMain(titleText, titleExpected);
        return this;
    }

    @Step
    public Past3MonthsCC clickOnAnswers(String ...answerText) {
