...
public class CurrentlyTakeMedicationPrescribedByHealthcareProvider_CC extends MainPageCC {
    ...
    @Step
    public CurrentlyTakeMedicationPrescribedByHealthcareProvider_CC waitForPageLoad() {
        waitForPageLoadMain(titleText, titleExpected);
        return this;
    }

    @Step
    public CurrentlyTakeMedicationPrescribedByHealthcareProvider_CC clickOnAnswer(String answerText) {
