...
public class HaveUeverHadBotoxMigCC extends MainPageCC{
    ...
    public HaveUeverHadBotoxMigCC() {
        PageFactory.initElements(getDriver(), this);
    }

    @Step
    public HaveUeverHadBotoxMigCC waitForPageLoad() {
        waitForAnimation();
    ...
    @Step
    public HaveUeverHadBotoxMigCC clickOnAnswer(String answerText) {
