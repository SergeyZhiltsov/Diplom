...
public class HowLongHaveYouBeenTaking_CC extends MainPageCC{
    ...
    public final String titleExpected5 = "How long have you been taking Aciphex (rabeprazole)? (Agent Note: AH-si-fex, ruh-BEP-ruh-zole)";
    public final String titleExpected6 = "How long have you been taking Dexilant (dexlansoprazole)? (Agent Note: DEX-ih-lant, dex-lan-SOP-ruh-zole)";
    public final String titleExpected7 = "How long have you been taking Protonix (pantoprazole)? (Agent Note: pro-TAHN-ix, pan-TOP-ruh-zole)";
    public final String titleExpected1 = "How long have you been taking Nexium (esomeprazole)? (Agent Note: NEX-ee-um, eh-so-MEP-ruh-zole)";
    public final String titleExpected2 = "How long have you been taking Prevacid (lansoprazole)? (Agent Note: PREV-uh-sid, lan-SOP-ruh-zole)";
    public final String titleExpected3 = "How long have you been taking Prilosec (omeprazole)? (Agent Note: PRY-lo-sec, oh-MEP-ruh-zole)";
    public final String titleExpected4 = "How long have you been taking Zegerid (omeprazole and sodium bicarbonate)? (Agent Note: ZEGG-er-rid, oh-MEP-ruh-zole, SO-dee-um bi-CAR-bo-nate)";
