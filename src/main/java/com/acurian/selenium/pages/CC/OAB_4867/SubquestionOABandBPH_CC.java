...
public class SubquestionOABandBPH_CC extends MainPageCC{
    ...
    public SubquestionOABandBPH_CC() {
        PageFactory.initElements(getDriver(), this);
    }

    @Step
    public SubquestionOABandBPH_CC waitForPageLoad(int actualTitleIndex, String expectedTitle) {
        waitForAnimation();
    ...
    @Step
    public SubquestionOABandBPH_CC clickOnAnswerForSubQuestion(int questionNumber, String answerText) {
    ...
    @Step
    public SubquestionOABandBPH_CC clickOnAnswerForSubQuestion(String questionText, String answerText) {
