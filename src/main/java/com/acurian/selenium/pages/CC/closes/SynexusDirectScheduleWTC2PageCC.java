...
public class SynexusDirectScheduleWTC2PageCC extends MainPageCC{

    //4356 Synexus Direct Schedule Warm Transfer Close 2
    ...
    public SynexusDirectScheduleWTC2PageCC() {
        PageFactory.initElements(getDriver(), this);
    }

    @Step
    public SynexusDirectScheduleWTC2PageCC waitForPageLoad() {
        waitForPageLoadMain(titleText, titleExpected);
        return this;
    }

    @Step
    public SynexusDirectScheduleWTC2PageCC clickOnAnswer(String answerText) {
