...
public class ExperiencingMigraineRightNowCC extends MainPageCC {
    ...
    public ExperiencingMigraineRightNowCC() {
    ...
    @Step
    public ExperiencingMigraineRightNowCC clickOnAnswer(String answerText) {
