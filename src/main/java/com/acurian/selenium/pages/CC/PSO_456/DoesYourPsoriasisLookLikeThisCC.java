...
public class DoesYourPsoriasisLookLikeThisCC extends MainPageCC {
    ...
    @Step
    public DoesYourPsoriasisLookLikeThisCC waitForPageLoad() {
        waitForPageLoadMain(titleText, titleExpected);
        return this;
    }

    @Step
    public DoesYourPsoriasisLookLikeThisCC clickOnAnswer(String answerText) {
