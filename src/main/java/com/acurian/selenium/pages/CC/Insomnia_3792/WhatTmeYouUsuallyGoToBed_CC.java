...
public class WhatTmeYouUsuallyGoToBed_CC extends MainPageCC {

   
    public final String titleExpected ="What time do you usually go to bed to try to sleep?";

    
    @FindBy(xpath = "(//span[@class='sub_question_text'])[1]")
    ...
    public WhatTmeYouUsuallyGoToBed_CC() {
        PageFactory.initElements(getDriver(), this);
    }

    
    @Step
    public WhatTmeYouUsuallyGoToBed_CC waitForPageLoad() {
    ...
    @Step
    public WhatTmeYouUsuallyGoToBed_CC selectGo_to_bed(String go_to_bed) {
    	selectDropDownListOptionByText(gotobedSelect, go_to_bed);
        return this;
    }

    @Step
    public WhatTmeYouUsuallyGoToBed_CC selectGet_out_of_bed(String get_out_of_bed) {
