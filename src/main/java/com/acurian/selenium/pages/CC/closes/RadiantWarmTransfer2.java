...
public class RadiantWarmTransfer2 extends MainPageCC{
    ...
    public RadiantWarmTransfer2() {
        PageFactory.initElements(getDriver(), this);
    }

    @Step
    public RadiantWarmTransfer2 waitForPageLoad() {
        waitForAnimation();
    ...
    @Step
    public RadiantWarmTransfer2 clickOnAnswer(String answerText) {
