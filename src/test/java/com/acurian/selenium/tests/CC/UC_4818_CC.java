...
//Q18 - Do you currently have any of the following?
        ...
        disqualifyQ24.put("History of a bowel resection within the past 3 months", Arrays.asList(site.activeProtocols[0])); //Disqualify (“Crohn’s complication or surgery”)
        disqualifyQ24.put("Colostomy", Arrays.asList(site.activeProtocols[0]));
        disqualifyQ24.put("Ileostomy", Arrays.asList(site.activeProtocols[0]));
        disqualifyQ24.put("Feeding tube", Arrays.asList(site.activeProtocols[0]));
        disqualifyQ24.put("IV (parenteral) nutrition (Agent Note: puh-REN-ter-ul)", Arrays.asList(site.activeProtocols[0]));
