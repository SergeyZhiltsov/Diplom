...
import com.acurian.selenium.pages.CC.shared.WomenHealthConditionsCC;
...
HowManyDaysYouSufferCC howManyDaysYouSufferCC = howLongSufferingFromMigraineCC
       ...
       .waitForPageLoad();
debugPageCC.checkProtocolsContainsForQNumber("Q0005099-QS6004-STUDYQUES", protocol1, protocol2);
debugPageCC.back();
...
HowOftenDoYouTypicallyTakeMedicationCC howOftenDoYouTypicallyTakeMedicationCC = howManyDaysYouSufferCC
       ...
       .clickNextButton(new HowOftenDoYouTypicallyTakeMedicationCC())
		.waitForPageLoad();
debugPageCC.checkProtocolsContainsForQNumber("Q0017149-QS6005-STUDYQUES", protocol1,protocol2);
debugPageCC.back();
...
HowManyDifferentMedicationsCC howManyDifferentMedicationsCC = howOftenDoYouTypicallyTakeMedicationCC
       ...
       .waitForPageLoad();
debugPageCC.checkProtocolsContainsForQNumber("Q0018412-QS6023-STUDYQUES", protocol1,protocol2);
debugPageCC.back();
...
HaveUeverDiagnosedByHealthcareProfesionalCC haveUeverDiagnosedByHealthcareProfesionalCC = whenYouLastHaveBotoxMigCC
       ...
       .waitForPageLoad();
		debugPageCC.checkProtocolsContainsForQNumber("Q0018421-QS6026-STUDYQUES", protocol1,protocol2);
		debugPageCC.back();
...
DoYouCurrentlyUseMarijuanaCC doYouCurrentlyUseMarijuanaCC = haveUeverDiagnosedByHealthcareProfesionalCC
       ...
       .waitForPageLoad();
       debugPageCC.checkProtocolsContainsForQNumber("Q0005117-QS6027-STUDYQUES", protocol1,protocol2);
		debugPageCC.back();
haveUeverDiagnosedByHealthcareProfesionalCC
       .waitForPageLoad()
       .clickOnAnswers("None of the above")
...
ifYouQualifyForStudyWillingtoStopCC
       ...
       .clickNextButton(new TransitionStatementCC())
       .waitForPageLoad(studyName);
		debugPageCC.checkProtocolsContainsForQNumber("Q0018426-QS6029-STUDYQUES", protocol1,protocol2);
		debugPageCC.back();
ifYouQualifyForStudyWillingtoStopCC
       .waitForPageLoad()
       .clickOnAnswer("Yes")
...
debugPageCC.checkProtocolsContainsForQNumber("Q0015129-QS47-STUDYQUES", protocol1,protocol2);
debugPageCC.back();
