...
public class DERM_4814_OLS extends BaseTest{
    ...
    public void DERM_4814_OLS_test() {
		...
		debugPageOLS.checkProtocolsContainsForQNumber("QS5802", protocol1,protocol2);
		debugPageOLS.back();
		...
		debugPageOLS.checkProtocolsContainsForQNumber("QS5803", protocol1,protocol2);
		debugPageOLS.back();
		...
		whichPartsOfYourBodyAreCurrentlyAffectedByEczema_OLS
					...
					.clickNextButton(new HaveYouEverBeenDiagnosedWithAnyOfFollowingHealthCondOLS());
		haveYouEverBeenDiagnosedWithAnyOfFollowingHealthCondOLS.waitForPageLoad();
		debugPageOLS.checkProtocolsContainsForQNumber("QS5805", protocol1,protocol2);
		debugPageOLS.back();		
		...
		debugPageOLS.checkProtocolsContainsForQNumber("QS5815", protocol1,protocol2);
		debugPageOLS.back();
		...
		haveYouEverTreatedYourEczema_OLS
					.waitForPageLoad();
		debugPageOLS
					//.checkProtocolsContainsForQNumber("QS5815", protocol1,protocol2)
					.back();
		whichOfThesePicsLooksSimilarOnYourChestStomachBack_Comp_OLS
					.waitForPageLoad()
					.clickOnAnswer("B")
		...
		/*			.waitForPageLoad();
					//debugPageOLS.checkProtocolsContainsForQNumber("QS5829", protocol1,protocol2);
					//debugPageOLS.back();
		//whichofthefollowingMedicationsTherapies_OLS
					.waitForPageLoad();
		...
		biologicMedications
					...
					.waitForPageLoad();
		debugPageOLS.checkProtocolsContainsForQNumber("QS5821", protocol1,protocol2);
		debugPageOLS.back();
		biologicMedications
					.waitForPageLoadKAD();
		...
		haveYouEverTakenEitherAnyOfFollowingMeds_OLS
					...
					.clickNextButton(new HaveYouEverBeenDiagnosedWithAnyOfFollowingHealthCondOLS())
					.waitForPageLoad();
		debugPageOLS.checkProtocolsContainsForQNumber("QS5830", protocol1,protocol2);
		debugPageOLS.back();
		haveYouEverTakenEitherAnyOfFollowingMeds_OLS
					.waitForPageLoad()
					.clickOnAnswers("None of the above")
		...
		debugPageOLS.checkProtocolsContainsForQNumber("QS42", protocol1,protocol2);
		debugPageOLS.back();
		cancerPage
					.waitForPageLoad()
					.back();		
		...
		debugPageOLS.checkProtocolsContainsForQNumber("QS61", protocol1,protocol2);
		debugPageOLS.back();
		doAnyOftheFollowingAdditionalDiagnosesOLS
					...
					.clickNextButton(new ApproximateHeightPageOLS())
					.waitForPageLoad();
		debugPageOLS.checkProtocolsContainsForQNumber("QS59", protocol1,protocol2);
		debugPageOLS.back();
		doAnyOftheFollowingAdditionalDiagnosesOLS
					.waitForPageLoad()
