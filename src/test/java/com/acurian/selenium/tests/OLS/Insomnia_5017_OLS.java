...
public class Insomnia_5017_OLS extends BaseTest{
    ...
    public void insomnia5017olsTest(Site site) {
        ...
        dateOfBirthPageOLS
                ...
                .waitForPageLoad();
        Assert.assertEquals(dateOfBirthPageOLS.getTitleText(), dateOfBirthPageOLS.getExpectedModifiedTitle("an insomnia study", "1,250"), "Title is diff");
...
////-------------------New GENERAL HEALTH---------------------------
        ...
        TransitionStatementCVbeginPageOLS transitionStatementCVbeginPageOLS = approximateHeightPageOLS
                .waitForPageLoad()
                .setAll("3", "5", "100")
