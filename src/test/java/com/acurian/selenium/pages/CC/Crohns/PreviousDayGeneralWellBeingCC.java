...
public class PreviousDayGeneralWellBeingCC extends MainPageCC {
    ...
    @Step
    public PreviousDayGeneralWellBeingCC waitForPageLoad() {
        waitForPageLoadMain(titleText, titleExpected);
        return this;
    }

    @Step
    public PreviousDayGeneralWellBeingCC clickOnAnswer(String answerText) {
