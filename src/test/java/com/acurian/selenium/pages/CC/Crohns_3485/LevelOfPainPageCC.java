...
public class LevelOfPainPageCC extends MainPageCC{
    ...
    public LevelOfPainPageCC() {
        PageFactory.initElements(getDriver(), this);
    }

    @Step
    public LevelOfPainPageCC waitForPageLoad() {
        waitForPageLoadMain(titleText, titleExpected);
        return this;
    }

    @Step
    public LevelOfPainPageCC setRating(String number) {
