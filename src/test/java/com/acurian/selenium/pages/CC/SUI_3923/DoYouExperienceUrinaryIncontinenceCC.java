...
public class DoYouExperienceUrinaryIncontinenceCC extends MainPageCC{
    ...
    public DoYouExperienceUrinaryIncontinenceCC() {
    ...
    @Step
    public DoYouExperienceUrinaryIncontinenceCC clickOnAnswers(String ...answerText) {
