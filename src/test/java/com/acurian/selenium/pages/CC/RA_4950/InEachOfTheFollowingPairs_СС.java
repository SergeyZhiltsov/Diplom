...
public class InEachOfTheFollowingPairs_СС extends MainPageCC {
    ...
    public InEachOfTheFollowingPairs_СС() {
        PageFactory.initElements(getDriver(), this);
    }

    @Step
    public InEachOfTheFollowingPairs_СС waitForPageLoad() {
        waitForPageLoadMain(titleText, titleExpected);
        return this;
    }

    @Step
    public InEachOfTheFollowingPairs_СС clickOnAnswer(String answerText) {
