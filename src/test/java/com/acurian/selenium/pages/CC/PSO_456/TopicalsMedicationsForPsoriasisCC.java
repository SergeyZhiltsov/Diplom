...
public class TopicalsMedicationsForPsoriasisCC extends MainPageCC {
    ...
    public TopicalsMedicationsForPsoriasisCC() {
        PageFactory.initElements(getDriver(), this);
    }

    @Step
    public TopicalsMedicationsForPsoriasisCC waitForPageLoad() {
        waitForAnimation();
    ...
    @Step
    public TopicalsMedicationsForPsoriasisCC clickOnAnswer(String answerText) {
