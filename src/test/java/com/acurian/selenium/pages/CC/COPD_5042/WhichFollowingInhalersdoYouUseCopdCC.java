...
public class WhichFollowingInhalersdoYouUseCopdCC extends MainPageCC{
    ...
    public WhichFollowingInhalersdoYouUseCopdCC() {
        PageFactory.initElements(getDriver(), this);
    }

    @Step
    public WhichFollowingInhalersdoYouUseCopdCC waitForPageLoad() {
        waitForAnimation();
    ...
    @Step
    public WhichFollowingInhalersdoYouUseCopdCC clickOnAnswers(String ...answerText) {
