...
public class WhenYouDiagnosedWithRaPageCC extends MainPageCC {
    ...
    public WhenYouDiagnosedWithRaPageCC() {
        PageFactory.initElements(getDriver(), this);
    }

    @Step
    public WhenYouDiagnosedWithRaPageCC waitForPageLoad() {
        waitForPageLoadMain(titleText, titleExpected);
        return this;
    }

    @Step
    public WhenYouDiagnosedWithRaPageCC clickOnAnswer(String answerText) {
