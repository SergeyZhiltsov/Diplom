...
public class PreviousDayAbdominalPainCC extends MainPageCC {
    ...
    @Step
    public PreviousDayAbdominalPainCC waitForPageLoad() {
        waitForPageLoadMain(titleText, titleExpected);
        return this;
    }

    @Step
    public PreviousDayAbdominalPainCC clickOnAnswer(String answerText) {
