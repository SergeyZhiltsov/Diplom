...
public class RegularFUL extends FollowupLetter {
    ...
    private final String fourthParagText = "Clinical research studies greatly contribute to the overall progress in understanding and finding future treatments for " +
            "diseases and we appreciate your interest in participation.\n" +
    ...
    public RegularFUL(String businessDays) {
        PageFactory.initElements(getDriver(), this);
    ...
    @Step
    public FollowupLetter assertgmailRegularFUL(String pid, String siteNameText) {
