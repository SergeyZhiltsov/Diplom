...
public class WhichOfThesePicsLooksSimilarOnYourLegsFeet_SmartPh_OLS extends MainPageOLS {
    ...
    public WhichOfThesePicsLooksSimilarOnYourLegsFeet_SmartPh_OLS() {
    ...
    @Step
    public WhichOfThesePicsLooksSimilarOnYourLegsFeet_SmartPh_OLS clickOnAnswer(String answerText) {
