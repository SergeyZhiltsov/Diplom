...
public class DiagnosedWithAnkylosingSpondylitisPageOLS extends MainPageOLS{
    ...
    public DiagnosedWithAnkylosingSpondylitisPageOLS() {
        PageFactory.initElements(getDriver(), this);
    }

    @Step
    public DiagnosedWithAnkylosingSpondylitisPageOLS waitForPageLoad() {
        waitForPageLoadMain(titleText, titleExpected);
        return this;
    }

    @Step
    public DiagnosedWithAnkylosingSpondylitisPageOLS clickOnAnswer(String answerText) {
