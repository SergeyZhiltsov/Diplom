...
public class StatinMedicationsHavePageOLS extends MainPageOLS{
    ...
    public StatinMedicationsHavePageOLS() {
        PageFactory.initElements(getDriver(), this);
    }

    @Step
    public StatinMedicationsHavePageOLS waitForPageLoad() {
        waitForPageLoadMain(titleText, titleExpected);
        return this;
    }

    @Step
    public StatinMedicationsHavePageOLS clickOnAnswers(String ...answerText) {
