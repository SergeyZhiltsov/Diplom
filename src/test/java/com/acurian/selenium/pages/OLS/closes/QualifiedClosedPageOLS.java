...
public class QualifiedClosedPageOLS extends MainPageOLS{
    ...
    public final String titleExpected = "We're glad the location is convenient for you.\n"  +
            "We will forward your contact information to the doctor’s office that you selected so they may contact you for further evaluation using the phone\n" +
    		"number you provided. Or you can schedule your appointment now by calling 855-382-9810.";
