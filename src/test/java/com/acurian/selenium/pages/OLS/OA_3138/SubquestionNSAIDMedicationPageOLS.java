...
public class SubquestionNSAIDMedicationPageOLS extends MainPageOLS {
    ...
    public SubquestionNSAIDMedicationPageOLS() {
        PageFactory.initElements(getDriver(), this);
    }

    @Step
    public SubquestionNSAIDMedicationPageOLS waitForPageLoad(int actualTitleIndex, String expectedTitle) {
        waitForAnimation();
    ...
    @Step
    public SubquestionNSAIDMedicationPageOLS clickOnAnswerForSubQuestion(int questionNumber, String answerText) {
    ...
    @Step
    public SubquestionNSAIDMedicationPageOLS clickOnAnswerForSubQuestion(String questionText, String answerText) {
    ...
    @Step
    public SubquestionNSAIDMedicationPageOLS clickOnAnswerForAllSubQuestion(String answerText) {
