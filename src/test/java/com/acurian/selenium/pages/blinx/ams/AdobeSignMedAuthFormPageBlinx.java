...
public class AdobeSignMedAuthFormPageBlinx extends MainPageBlinx {
    ...
    @Step
    public AdobeSignMedAuthFormPageBlinx waitForPageLoad() {
    ...
    @Step
    public AdobeSignMedAuthFormPageBlinx setSignature(String signature) {
