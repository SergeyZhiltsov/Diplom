...
public class PersonalIdentificationPageOLS extends MainPageBlinx {
    ...
    @Step
    public PersonalIdentificationPageOLS waitForPageLoad() {
    ...
    @Step
    public PersonalIdentificationPageOLS waitForPageLoad2() {
        waitForPageLoadMain(titleTextPart2, titleExpectedPart2);
    ...
    @Step
    public PersonalIdentificationPageOLS setAllFields(String firstName, String lastName, String email, String phoneNumber,
    ...
    @Step
    public PersonalIdentificationPageOLS setFirstName(String firstName) {
        typeTextWithoutClear(firstNameField, firstName);
        return this;
    }

    @Step
    public PersonalIdentificationPageOLS setLastName(String lastName) {
        typeTextWithoutClear(lastNameField, lastName);
        return this;
    }

    @Step
    public PersonalIdentificationPageOLS setEmailAddress(String email) {
        typeTextWithoutClear(emailAddressField, email);
        return this;
    }

    @Step
    public PersonalIdentificationPageOLS setPhone(String phoneNumber) {
        typeTextWithoutClear(phoneField, phoneNumber);
        return this;
    }

    @Step
    public PersonalIdentificationPageOLS setZipCode(String zipCode) {
        typeTextWithoutClear(zipCodeField, zipCode);
        return this;
    }

    @Step
    public PersonalIdentificationPageOLS setCity(String city) {
        typeTextWithoutClear(cityField, city);
        return this;
    }

    @Step
    public PersonalIdentificationPageOLS setState(String state) {
