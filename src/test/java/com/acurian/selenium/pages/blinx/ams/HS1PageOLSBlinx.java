...
public class HS1PageOLSBlinx extends MainPageBlinx {
    ...
    @Step
    public HS1PageOLSBlinx waitForPageLoad() {
        waitForAnimation();
        try {
            acceptAlert();
            acceptAlert();
    ...
    @Step
    public HS1PageOLSBlinx clickOkInPopUp() {
        waitForAnimation();
    ...
    @Step
    public HS1PageOLSBlinx setSignature() {
        waitForAnimation();
    ...
    @Step
    public HS1PageOLSBlinx waitToClickNext() {
