...
public class DoctorInformationCollectionPageOLSBlinx extends MainPageBlinx {
    ...
    public DoctorInformationCollectionPageOLSBlinx() {
        PageFactory.initElements(getDriver(), this);
    }

    @Step
    public DoctorInformationCollectionPageOLSBlinx waitForPageLoad() {
