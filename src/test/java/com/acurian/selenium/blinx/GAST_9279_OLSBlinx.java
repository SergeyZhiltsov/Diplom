...
import com.acurian.selenium.OLS.GAST_9279_OLS;
...
public class GAST_9279_OLSBlinx extends BaseTest {

    private static Logger Log = LogManager.getLogger(GAST_9279_OLS.class.getName());
...
// ---- START Q9 Ghost Question - Gastroparesis Logic check ----
        ...
        followingAreCommonSymptomsOLS
                ...
                .back(everDiagnosedGastroparesisOrStomachEmptyingOLS);
        ...
        for (String answer: DQ13) {
            ...
            gastroparesisSymptomsCausedByFollowingPageOLS
                    ...
                    .back(gastroparesisSymptomsCausedByFollowingPageOLS);
        }
