...
import com.acurian.selenium.pages.blinx.ams.lps_4442.*;
...
public class Lupus_4442_OLSBlinx extends BaseTest {
    ...
    public void lupus4442olsTest() {
        ...
        String studyName = "a lupus study";
        ...
        debugPageOLS.back(dateOfBirthPageOLS);
        ...
        haveYouEverBeenDiagnosedWithAnyOfFollowingHealthCondOLS
                ...
                .checkProtocolsContainsForQNumber("QS6102", protocol1, protocol2)
                .back(diagnosedYouWithLupusOLS);
        ...
        whatTypeOfLupusOLS
                ...
                .waitForPageLoad()
                .getPage(debugPageOLS)
                .checkProtocolsContainsForQNumber("QS6116", protocol1, protocol2)
                .back(whatTypeOfLupusOLS);
        whatTypeOfLupusOLS
                .waitForPageLoad2()
        ...
        debugPageOLS.back(whatTypeOfLupusOLS);
        ...
        debugPageOLS.back(whenWereYouDiagnosedOLS);
        ...
        debugPageOLS.back(typeOfDoctorCurrentlySeeToHelpManageYourLupusOLS);
        ...
        debugPageOLS.back(currentlyTakingPrescriptionMedicationsOLS);
        ...
        BiologicMedications biologicMedications = medicationsCurrentlyTakingToTreatLupusOLS
                ...
                .waitForPageLoadKAD();
        biologicMedications.back(medicationsCurrentlyTakingToTreatLupusOLS);
        ...
        EitherOfFollowingMedicationsOLS eitherOfFollowingMedicationsOLS = biologicMedications
                .waitForPageLoadKAD()
                .clickOnAnswers("Actemra", "Benlysta", "Cimzia", "Cosentyx", "Enbrel", "Entyvio", "Humira",
                ...
                .waitForPageLoad();
        eitherOfFollowingMedicationsOLS.back(biologicMedications);
        biologicMedications
                .waitForPageLoadKAD()
                .clickOnAnswers("None of the above")
                .clickNextButton(new EitherOfFollowingMedicationsOLS());
        ...
        debugPageOLS.back(eitherOfFollowingMedicationsOLS);
        eitherOfFollowingMedicationsOLS
                .waitForPageLoad()
        ...
        experienceWithYourLupusOLS
                ...
                .waitForPageLoad();
        haveYouEverBeenDiagnosedWithAnyOfFollowingHealthCondOLS
                .back(experienceWithYourLupusOLS);
        experienceWithYourLupusOLS
                .waitForPageLoad()
                .clickOnAnswers("None of the above")
                .clickNextButton(new HaveYouEverBeenDiagnosedWithAnyOfFollowingHealthCondOLS());
        ...
        debugPageOLS.back(whenDiagnosedWithCancerOLS);
        ...
        debugPageOLS.back(subquestionExperiencedHeartPageOLS);
...
//                .clickOnAnswers("Prefer not to answer")
                ...
                .waitForPageLoad2()
                .setAllFields("Acurian", "Trial", eMailId, "9999999999")
