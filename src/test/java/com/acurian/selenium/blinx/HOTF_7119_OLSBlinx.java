...
import com.acurian.selenium.pages.blinx.ams.hotf_7119.AreYouCurrentlyTreatingYourHotFlashesWithPrescriptionMedicationOLS;
import com.acurian.selenium.pages.blinx.ams.hotf_7119.DoyouExperienceHotFlashesOLS;
import com.acurian.selenium.pages.blinx.ams.hotf_7119.HowWouldYouDescribeYourHotFlashesOLS;
import com.acurian.selenium.pages.blinx.ams.hotf_7119.OnAvgHowManyHotFlashesDoYouExperiencePerDayOLS;
...
public class HOTF_7119_OLSBlinx extends BaseTest {
...
//                "Title is diff");
        ...
        doyouExperienceHotFlashesOLS
                ...
                .back(doyouExperienceHotFlashesOLS);
        ...
        for (String answer : disqualifyQ3) {
            ...
            onAvgHowManyHotFlashesDoYouExperiencePerDayOLS
                    ...
                    .back(onAvgHowManyHotFlashesDoYouExperiencePerDayOLS);
        }
        onAvgHowManyHotFlashesDoYouExperiencePerDayOLS
                .waitForPageLoad()
                .clickOnAnswer("7 - 8")
        ...
        haveYouGoneThroughMenopauseOLS
                ...
                .checkProtocolsContainsForQNumber("QS7604", site.activeProtocols[0],
                        site.activeProtocols[1])
                .back(howWouldYouDescribeYourHotFlashesOLS);
        ...
        areYouCurrentlyTreatingYourHotFlashesWithPrescriptionMedicationOLS
                ...
                .back(areYouCurrentlyTreatingYourHotFlashesWithPrescriptionMedicationOLS);
        areYouCurrentlyTreatingYourHotFlashesWithPrescriptionMedicationOLS
                .waitForPageLoad()
                .clickOnAnswer("No")
...
//#############General_Health ###########################
        ...
        QualifiedClose2PageOLS qualifiedClose2PageOLS = siteSelectionPageOLS
                .waitForPageLoad5(studyName + "!") //todo
                .getPID()
