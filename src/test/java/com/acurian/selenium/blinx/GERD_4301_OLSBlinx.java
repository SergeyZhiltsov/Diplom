...
public class GERD_4301_OLSBlinx extends BaseTest {
...
//                .getExpectedModifiedTitle(studyName + " study", "500"), "Title is diff");
        ...
        EverDiagnosedWithFollowingConditionsOLS everDiagnosedWithFollowingConditionsOLS = howManyDaysPerWeekHaveSymptomsOLS
                .waitForPageLoad()
