...
import com.acurian.selenium.pages.blinx.ams.adg_4357.*;
...
public class GAST_4357_OLSBlinx extends BaseTest {

    private static Logger Log = LogManager.getLogger(GAST_4357_OLSBlinx.class.getName());
...
//                {Site.AUT_GAST4357S_site, true}
    ...
    public void gast4357blinxTest(final Site site, boolean inFlare) {
...
//Q10
        howLongBeenHavingThoseSymptomsPageOLS
                ...
                .back(howLongBeenHavingThoseSymptomsPageOLS);
        ...
        CurrentlyHaveAnyFollowingOLS currentlyHaveAnyOffFollowingPageOLS = opioidOrNarcoticMedicationPageOLS
                .waitForPageLoad()
                .clickOnAnswer("Yes, every day")
                .clickNextButton(new CurrentlyHaveAnyFollowingOLS());
...
//-------------------New GENERAL HEALTH---------------------------
        ...
        WomenHealthConditions womenHealthConditionsOLS = haveYouEverBeenDiagnosedWithAnyOfFollowingHealthCondOLS
                .waitForPageLoad()
                .clickOnAnswers("None of the above")
        ...
        //Q24: QS59
        List<String> listAnswers = Arrays.asList(
                "Cancer in the past 5 years, except skin cancer",
                "Cirrhosis",
                "Hepatitis B",
                "Hepatitis C",
        ...
        siteSelectionPageOLS
                .waitForPageLoad5("a gastroparesis study for people with digestion problems!")
                .getPID();
            ...
            switch (site) {
                ...
                case AUT_GAS4357ds: {
                    try {
                        ...
                        dRSBlinx.threadSleep(1);
                        ArrayList<String> tabs = new ArrayList<String>(getDriver().getWindowHandles());
                        getDriver().switchTo().frame(tabs.get(0));
                        dRSBlinx
