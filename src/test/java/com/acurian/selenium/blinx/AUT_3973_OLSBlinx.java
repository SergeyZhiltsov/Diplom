...
import com.acurian.selenium.pages.blinx.ams.autism_3973.*;
...
public class AUT_3973_OLSBlinx extends BaseTest {

    @Test(enabled = true)
    @Description("Akcea_4691 OLS")
    public void aut3973BlinxTest() {
        ...
        debugPageOLS
                ...
                .back(haveYouEverBeenToldByDoctorAutism_OLS);
        ...
        inThePast3MonthsHaveYouExperienced_OLS
                ...
                .checkProtocolsContainsForQNumber("QS5903", site.activeProtocols)
                .back(inThePast3MonthsHaveYouExperienced_OLS);
        inThePast3MonthsHaveYouExperienced_OLS
                .waitForPageLoad();
        HaveYouHadSeizureInLast6Mon_OLS haveYouHadSeizureInLast6Mon_OLS = inThePast3MonthsHaveYouExperienced_OLS
                .clickOnAnswers("Trouble understanding what other people are feeling",
                        "Trouble understanding facial expressions or what other people want",
        ...
        haveYouHadSeizureInLast6Mon_OLS
                ...
                .back(haveYouHadSeizureInLast6Mon_OLS);
        haveYouHadSeizureInLast6Mon_OLS
                .waitForPageLoad();
        ...
        haveYouEverHadAnIQtest_OLS
                ...
                .waitForPageLoad()
                .back(haveYouEverHadAnIQtest_OLS);
        haveYouEverHadAnIQtest_OLS
                .waitForPageLoad();
        ...
        howDidYouScoreOnTheTest_OLS
                ...
                .back(howDidYouScoreOnTheTest_OLS);
        howDidYouScoreOnTheTest_OLS
                .waitForPageLoad();
